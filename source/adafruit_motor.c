...
void adafruitMotorInitialize(void) {
	...
	uint8_t initBuf[] = {
			 ...
			 * Motor 3 CCW (AO2)
			 */
			0x00,0x00, 0x00, FULL_OFF,//LED 2 PWMA
			0x00,FULL_ON,0x00,0x00,//LED 3 AIN2
			0x00,0x00,0x00,FULL_OFF,//LED 4 AIN1
			/**
			 * Motor 4 CW (AO1)
			 */
			0x00,FULL_ON,0x00,0x00,//LED 5
			0x00,0x00,0x00,FULL_OFF,//LED 6
			0x00,0x00,0x00,FULL_OFF,//LED 7
			/**
			 * Motor 1 CCW (AO2)
			 */
			0x00,0x00,0x00,FULL_OFF,//LED 8
			0x00,FULL_ON,0x00,0x00,//LED 9
			0x00,0x00,0x00,FULL_OFF,//LED 10
			/**
			 * Motor 2 CW (AO1)
			 */
			0x00,FULL_ON,0x00,0x00,//LED 11
			0x00,0x00,0x00,FULL_OFF,//LED 12
			0x00,0x00,0x00,FULL_OFF//LED 13
	};
